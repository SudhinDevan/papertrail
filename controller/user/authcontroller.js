...
const forgotPassword = async (req, res) => {
  try {
    ...
    if (!emailMatch) {
      res.render("Authentication/forgotPassword", {
        message: "Account for this email does'nt exist",
        user: null,
        cart: null,
      });
    } else {
...
const verifyForgotPasswordOtp = async (req, res) => {
  try {
    ...
    if (verified) {
      ...
      res.render("Authentication/newForgotPassword", {
        action: "/forgotPassword/newForgotPassword",
        user: null,
        cart: null,
      });
    } else {
